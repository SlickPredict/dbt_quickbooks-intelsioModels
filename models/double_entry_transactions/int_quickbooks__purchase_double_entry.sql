...
purchase_join as (
    ...
    select
        ...
        case when coalesce(purchases.credit, 'false') != 'false' then 'debit' else 'credit' end as payed_from_transaction_type,
        case when coalesce(purchases.credit, 'false') != 'false' then 'credit' else 'debit' end as payed_to_transaction_type,
